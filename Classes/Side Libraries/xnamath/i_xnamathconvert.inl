...
#elif defined(_XM_SSE_INTRINSICS_)
    XMASSERT(pSource);
	XMFLOAT4A tmp(XMConvertHalfToFloat(pSource->x), XMConvertHalfToFloat(pSource->y), 0.0f, 0.0f);
	return XMLoadFloat4A(&tmp);
#elif defined(XM_NO_MISALIGNED_VECTOR_ACCESS)
#endif // _XM_VMX128_INTRINSICS_
}
...
#elif defined(_XM_SSE_INTRINSICS_)
	XMASSERT(pSource);
	XMFLOAT4A tmp(XMConvertHalfToFloat(pSource->x), XMConvertHalfToFloat(pSource->y), XMConvertHalfToFloat(pSource->z), XMConvertHalfToFloat(pSource->w));
    return XMLoadFloat4A(&tmp);
#elif defined(XM_NO_MISALIGNED_VECTOR_ACCESS)
#endif // _XM_VMX128_INTRINSICS_
}
